...
def app():
    ...
    if 'qa_df' in locals() and not qa_df.empty:
        ...
        # Add a button to download the displayed data as an Excel file
        if st.button("Download Data as Excel"):
            # Create a BytesIO object to store the Excel data
            excel_buffer = io.BytesIO()

            # Use pandas to write the DataFrame to the BytesIO object as an Excel file
            ...
            href = f'<a href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}" download="Question_Answer_Data.xlsx">Download Excel File</a>'
